...
var MovieClip = function (_Container) {
    ...
    _createClass(MovieClip, [{
         ...
         */
        value: function addKeyframes(instance, keyframes) {
            if (!keyframes) {
                return;
            }
            ...
            var parseValue = function parseValue(frame, prop, buffer) {
                switch (prop) {
                    case 'c':
                        {
                            buffer = buffer.split(',');
        ...
        value: function addTween(instance, properties, startFrame, duration, ease) {
            ...
            if (typeof properties.t === 'string') {
                properties.t = _ColorUtils2.default.hexToUint(properties.t);
...
},{"./ColorUtils":1,"./Timeline":5}],3:[function(require,module,exports){
'use strict';
    ...
    value: function value(prop, draw) {
        ...
        for (var d in draw) {
            ...
            if (typeof arg === 'string' && arg[0] === '#') {
                draw[d] = _ColorUtils2.default.hexToUint(arg);
            }
        }
...
},{"./ColorUtils":1}],4:[function(require,module,exports){
'use strict';
...
},{"./ShapesCache":3}],5:[function(require,module,exports){
'use strict';
...
},{"./Tween":6}],6:[function(require,module,exports){
"use strict";
...
exports.default = {
    load: _load2.default,
    ColorUtils: _ColorUtils2.default,
...
},{"./ColorUtils":1,"./MovieClip":2,"./ShapesCache":3,"./SymbolLoader":4,"./Timeline":5,"./Tween":6,"./load":8}],8:[function(require,module,exports){
"use strict";
...
},{"./Container":9,"./DisplayObject":10,"./Graphics":11,"./Sprite":12,"./Text":13}],15:[function(require,module,exports){
'use strict';
...
},{"./animate":7,"./mixins":14,"loophole":undefined,"pixi.js/bin/pixi.js":undefined,"pixi.js/bin/pixi.min.js":undefined}]},{},[15])(15)
});
